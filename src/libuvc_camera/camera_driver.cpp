      ...
      param_init_(false)
{
    ...
    device_type_client = create_client<astra_camera::srv::GetDeviceType>("get_device_type");
    camera_info_client = create_client<astra_camera::srv::GetCameraInfo>("get_camera_info");
