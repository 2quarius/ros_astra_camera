...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        ...
        arg('hw_registered_processing', launch.substitutions.LaunchConfiguration('depth_registration') == 'true'),
        arg('sw_registered_processing', launch.substitutions.LaunchConfiguration('depth_registration') == 'false'),
        arg('respawn', 'false'),
